 ...
 */
export const internalDialStatusApiV1TelephonyInternalDialStatusGet = <ThrowOnError extends boolean = false>(options: Options<InternalDialStatusApiV1TelephonyInternalDialStatusGetData, ThrowOnError>) => (options.client ?? client).get<InternalDialStatusApiV1TelephonyInternalDialStatusGetResponses, InternalDialStatusApiV1TelephonyInternalDialStatusGetErrors, ThrowOnError>({ url: '/api/v1/telephony/internal/dial-status', ...options });
 ...
 * This is only called when the call was NOT answered (ANSWER is excluded by dialplan).
 */
export const internalDialStatusApiV1TelephonyInternalDialStatusPost = <ThrowOnError extends boolean = false>(options: Options<InternalDialStatusApiV1TelephonyInternalDialStatusPostData, ThrowOnError>) => (options.client ?? client).post<InternalDialStatusApiV1TelephonyInternalDialStatusPostResponses, InternalDialStatusApiV1TelephonyInternalDialStatusPostErrors, ThrowOnError>({ url: '/api/v1/telephony/internal/dial-status', ...options });
 ...
 *
 * Return organization-scoped configuration signals owned by Dailsmart.
 */
 ...
 *
 * Create a checkout URL for organizations using Dailsmart-managed MPS v2.
 */
