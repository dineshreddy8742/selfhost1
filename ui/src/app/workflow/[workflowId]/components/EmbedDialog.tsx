                                        ...
                                        <div className="space-y-3">
                                            <div className="rounded-lg bg-muted/50 p-4">
                                                ...
                                                <ul className="text-sm space-y-2 text-muted-foreground">
                                                    ...
                                                    <li>• Call <code className="text-xs">window.DailsmartWidget.start()</code> to begin a call.</li>
                                                    <li>• Call <code className="text-xs">window.DailsmartWidget.end()</code> to end it.</li>
...
window.DailsmartWidget?.onStatusChange((status) => {
  callStatus = status;
...
document.getElementById('talk-btn').addEventListener('click', () => {
  if (callStatus === 'connected' || callStatus === 'connecting') {
    window.DailsmartWidget.end();
  } else {
    window.DailsmartWidget.start();
  }
});`}</code>
                                                </pre>
  ...
  useEffect(() => {
    window.DailsmartWidget?.onStatusChange(setStatus);
  }, []);

  const isLive = status === 'connected' || status === 'connecting';
  return (
    <button onClick={() => isLive ? window.DailsmartWidget.end() : window.DailsmartWidget.start()}>
                                        ...
                                        <div className="space-y-3">
                                            <div className="rounded-lg bg-muted/50 p-4">
                                                ...
                                                <ul className="text-sm space-y-2 text-muted-foreground">
                                                    ...
                                                    <li>• Call window.DailsmartWidget.start() to begin the call</li>
                                                    <li>• Call window.DailsmartWidget.end() to end the call</li>
                                                </ul>
                                            </div>
                                            ...
                                            <div className="rounded-lg bg-blue-50 dark:bg-blue-950/20 p-4 border border-blue-200 dark:border-blue-800">
                                                ...
                                                <pre className="text-xs overflow-x-auto">
                                                    <code className="text-blue-800 dark:text-blue-200">{`export function DailsmartAgent() {
  const [isCallActive, setIsCallActive] = useState(false);

  useEffect(() => {
    // Widget will auto-initialize when script loads
    window.DailsmartWidget?.onCallStart(() => {
      setIsCallActive(true);
    });
    window.DailsmartWidget?.onCallEnd(() => {
  ...
  return (
    <div className="my-8">
      ...
      <button
        onClick={() => window.DailsmartWidget?.start()}
